...
const mapData = {
    text: 'Фронтир',
    info: { "Фронтир": "В середині 18 сторіччя в результаті численних війн і конфліктів в місці впадіння Синюхи в Бог сходились кордони трьох імперій" },
    children: [
        {
            text: 'Річ Посполита',
            theme: 'polish', 
            info: { "Річ Посполита": "Після численних війн і козацьких повстань держава опинилася в глибокій кризі і головною ціллю ставила не розширення, а захист існуючих кордонів"  },
            children: [
                { 
                    text: 'Брацлавське воєводство', 
                    info: { "Брацлавське воєводство": "Прикордонна провінція Речі Посполитої, значна частина території якої належить різним польським магнатам, таким, як Потоцькі" },
                    children: [
                        { text: 'Богопіль', info: { "Богопіль": " " }, children: [] }
                    ]
                }
            ]
        },
        {
            ...
            theme: 'russian', 
            info: { "Російська імперія": "Офіційно контролює територію Запорозької січі і прагне створювати на її території заселені форпости на Праборежжі, як плацдарми для майбутніх завоювань" },
            children: [
                { 
                    text: 'Новослобідський полк', 
                    info: { "Новослобідський козацький полк": "Після того, як на Правобережній землі Миргородського полку була створена Нова сербія, всіх її українських поселенців примусили або повернутись на лівий берег, або переселитись за кордони Нової Сербії на південь. З цих поселенців і був утворений Новослобідський козацький полк" },
                    children: [
                        { text: 'Орел', info: { "Орел": " " }, children: [] }
                    ]
                }
            ]
        },
        {
            ...
            theme: 'ottoman', 
            info: { "Осмнаська імперія": "Контролювала значну частину сучасних українських територій через свого васала, Кримське ханство" },
            children: [
                { 
                    text: 'Ханська Україна', 
                    info: { "Ханська Україна": "Територія, утворена в середині 18 сторіччя Кримським ханом для економічного розвитку своїх степових володінь. Складалася з декількох десятків ханських слобід на півночі Єдисану, які були заселені переважно втікачами-українцями, яким пропонували пільгові умови існування" },
                    children: [
                        { text: 'Голта', info: { "Голта": " " }, children: [] }
                    ]
                }
            ]
        }
...
const historyData = [
    {
        id: 'orel',
        title: "Орел",
        text: "1757-го року козаками вихідцями з Архангелогорода на чолі з Василем Черніченком на лівому березі Богу в усті Синюхи була облаштована слобода, що отримала назву від місцевого урочища (з тюркської) Орел. Невдовзі стала сотенним центром Новослобідського козацького полку, першим сотником став вже згаданий Василь Черніченко."
    },
    {
        id: 'envoy',
        title: "Турецьке посольство",
        text: "У лютому 1759 року в слободі Орел утримувалися в карантині турецький посланець і його 30 татар з кіньми, що підкреслює дипломатичну та митну роль поселення."
    },
    {
        id: 'attack-orel',
        title: "Напад на Орел",
        text: "1761-го року слобода Орел була пограбована запорожцями на чолі з Бугогардівським полковником, що зумовлено тим, що запорозьке козацтво було незадоволено облаштуванням поселень на територіях їх вольностей, далі за раніше домовлені кордони Новослобідського полку."
    },
    {
        id: 'holta',
        title: "Голта",
        text: "В межах Ханської України, облаштованої Кримським ханом на північних прикордонних землях Єдисану, 1762-го року була заснована ханська слобода Голта, що швидко росла за рахунок перебіжників з території Запорожжя та Новослобідського полку. Керівником поселення був назначений ханом Каймакам."
    },
    {
        id: 'bohopil',
        title: "Богопіль",
        text: "За наказом воєводи Київського, Станіслава Потоцького весною 1763-го року починається зведення поселення, що потім буде назване Богопіль. Це викликає незадоволення московських урядовців, що вважають цю територію спірною."
    },
    {
        id: 'attack',
        title: "Знищення Богополя",
        text: "Незадоволені спорудженням поселення на польській стороні Синюхи, московити наказують ротмістру з козаками, що стояли в Орловській слободі зруйнувати Богопіль. Проте це не зупинило Потоцького і згодом спорудження відновилось."
    },
    {
        id: 'fort',
        title: "Укріплення Орла",
        text: "У зв'язку з облаштування Новоросійської провінції уряд наказує укріпити Орел для захисту переправи і торгівлі в регіоні."
    },
    {
        id: 'smuggling',
        title: "Тіньова економіка Фронтиру",
        text: "У лютому 1765 року кошовий отаман Запорозької Січі Петро Калнишевський через своїх підлеглих просив каймакана Голти пропустити придбані у Речі Посполитій товари (зокрема горілку) «без мита і платежу». Посадовці ворогуючих держав легко домовлялися, коли йшлося про їхні власні інтереси."
    },
    {
        id: 'fair',
        title: "Богопільський ярмарок",
